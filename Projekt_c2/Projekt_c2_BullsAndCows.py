...
def zadavani_cisla():
    """Zadavaní čisla hračem, validace hodnoty"""
    while hodnota := input("Zadej cislo:"):
        ...
        # Kontrola duplicity, zadany udaj je čislo, zadane cislo zacina nulo, kontrola delky zadaneho cisla
        if duplicita_nalezena or not hodnota.isdigit() or hodnota[0] == "0" or len(hodnota) != 4:
            print("Zadané čislo není zadano správně.")
            continue
        else:
            return hodnota
